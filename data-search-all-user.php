   ...
   <header id="app-login-header" role="banner">
         ...
         <div id="header-container" class="container">
            ...
            <div id="app-designer-navbar" class="navbar-collapse collapse">
               <ul class="nav navbar-nav navbar-right">
                  <li><a data-toggle="tooltip" data-placement="bottom" title="Search by" class="jv-search"><span class="fa fa-search "></span> <span> Search</span></a></li>
                  <li><a data-toggle="tooltip" data-placement="bottom" title="Sign-in/Login" href="page-login.php"><span class="fa fa-sign-in"></span> <span> Sign-in</span></a></li>
               </ul>
            </div>
         </div>
      </nav>
      <div class="search-box">
        <form class="app-input-group search" name="from2" method="get" action="data-search-all-user.php">
          ...
          <input type="submit" name="submit" value="Search" class="btn btn-default btn-search app-btn-grouping">
          </div>
        </form>
      </div>
   </header>
